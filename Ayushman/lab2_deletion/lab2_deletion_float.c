...
a program to delete floating point element(s) from one dimensional array
...
void menu(void)
{
	printf("\n\tLAB 2 DELETION PROGRAM! - float");
	printf("\n\t_______________________________\n\n");

	printf("\n\n\t\t\tMENU");

	printf("\n\n\t1. Enter floating point elements in the array.");
